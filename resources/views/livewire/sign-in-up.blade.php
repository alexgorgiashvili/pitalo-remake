    ...
    <div class="sign-up-main">
        ...
        <div class="sign-up-inn">
            <div class="sign-up-div">
                ...
                <div @click="$dispatch('custom-show-signup')" class="change-form-btn1">Sign Up</div>
            </div>  
            ...
            :class=" open1 ? 'hh-text1' : 'hh-text2'" >
                ...
                @custom-show-signup.window="open1 = false"
                 ...
                 >
                    ...
                    <input wire:model.defer='email'  type="email" class="form-inn-inp " name="email"  required autocomplete="email" autofocus> 
                ...
                >
                @csrf
                    <label  for="name"><i class="bi bi-envelope-fill form-inn-lab"></i></label>
